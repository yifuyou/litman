...
import com.yifuyou.litman.ColorSPUtil;
import com.yifuyou.litman.MainActivity;
...
public class RequestTestActivity extends AppCompatActivity {
        ...
        public void handleMessage(@NonNull Message msg) {
            ...
            switch (msg.what) {
                case 0x999:
                    ...
                    break;
                case 0x888:
                    Toast.makeText(RequestTestActivity.this, msg.obj.toString(), Toast.LENGTH_SHORT).show();
                    break;
            }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.request_test_layout);
...
//                http://apis.juhe.cn/simpleWeather/query?city=广州&key=a354ab396cd4ac85e65d6bc069560668
    ...
    public int checkSelfPermission(String permission) {
        Log.d(RequestTestActivity.this.getCallingPackage(), "checkSelfPermission: " + permission);
